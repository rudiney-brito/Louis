...
class SubscriptionViewController: UIViewController {
    ...
    private var viewModel: SubscriptionViewModelProtocol
    ...
    func update(subscription: Subscription?) {
        ...
        if let offers = subscription?.offers {
            for offer in offers {
                offerViewController.offers.append(offer)
            }
            offerViewController.applySnapshot()
        }
    ...
    func setup() {
        ...
        offerViewController.view.translatesAutoresizingMaskIntoConstraints = false
        
        addChild(offerViewController)
    
        secundary.addArrangedSubview(subscribeTitle)
        secundary.addArrangedSubview(subscribeSubtitle)
        secundary.addArrangedSubview(offerViewController.view)
        ...
        offerViewController.didMove(toParent: self)
        ...
        NSLayoutConstraint.activate([
            offerViewController.view.heightAnchor.constraint(equalToConstant: subscriptionHeight)
        ])
    ...
    init(viewModel: SubscriptionViewModelProtocol) {
